...
export default async function handler(request: Request) {
    ...
    try {
        ...
        await sql`
            ...
            ('مدير النظام', '000 شارع النظام', '5550000', 'SYS001', ${UserRole.SUPER_ADMIN}, 'superadminpassword'),
            ('مسؤول', '100 الشارع الرئيسي', '5550100', 'ADM001', ${UserRole.ADMIN}, 'adminpassword'),
            ('أليس جونسون', '123 شارع البلوط', '5550101', 'WTR001', ${UserRole.USER}, 'password123'),
            ('بوب ويليامز', '456 ممر الصنوبر', '5550102', 'WTR002', ${UserRole.USER}, 'password123'),
            ('تشارلي براون', '789 طريق القيقب', '5550103', 'WTR003', ${UserRole.USER}, 'password123');
        `;
